#!/usr/bin/env python3
"""
Export AI Access CSV (Full Version with Resume Content)
...
This version INCLUDES resume_content field with full extracted resume text.
WARNING: File size will be large (300+ MB) - not suitable for Zapier Tables.
Use this for SharePoint or other systems that can handle large files.

For lightweight version without resume_content, use export_ai_access_csv.py
"""
...
# Export directory - AI Database (Full exports WITH resume_content)
...
def export_ai_csv():
    ...
    try:
        ...
        # Export query - optimized for AI agent consumption
        ...
        # Include resume_content for direct text access
        export_query = """
        ...
        log(f"📝 Resume content: {stats['with_resume_content']:,} candidates ({stats['with_resume_content']/stats['total']*100:.1f}%)")
        log("")
